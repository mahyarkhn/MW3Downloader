...
namespace MW3Download.Download
{
    public class WebDownloadClient : INotifyPropertyChanged
    {
        ...
        public WebDownloadClient(string url)
        {
            ...
            this.MaxCacheSize = global::MW3Download.Properties.Settings.Default.MemoryCacheSize * 1024; // Default cache size is 1MB
        ...
        public void CheckUrl()
        {
            try
            {
                ...
                if (global::MW3Download.Properties.Settings.Default.ManualProxyConfig && global::MW3Download.Properties.Settings.Default.HttpProxy != String.Empty)
                {
                    this.Proxy = new WebProxy();
                    this.Proxy.Address = new Uri("http://" + global::MW3Download.Properties.Settings.Default.HttpProxy + ":" + global::MW3Download.Properties.Settings.Default.ProxyPort);
                    this.Proxy.BypassProxyOnLocal = false;
                    if (global::MW3Download.Properties.Settings.Default.ProxyUsername != String.Empty && global::MW3Download.Properties.Settings.Default.ProxyPassword != String.Empty)
                    {
                        this.Proxy.Credentials = new NetworkCredential(global::MW3Download.Properties.Settings.Default.ProxyUsername, global::MW3Download.Properties.Settings.Default.ProxyPassword);
                    }
                }
                if (this.Proxy != null)
                {
        ...
        public void Start()
        {
                ...
                || this.Status == DownloadStatus.Queued || this.HasError)
            {
                ...
                if (DownloadManager.Instance.ActiveDownloads > global::MW3Download.Properties.Settings.Default.MaxDownloads)
                {
        ...
        private void DownloadFile()
        {
            ...
            try
            {
                ...
                if (global::MW3Download.Properties.Settings.Default.EnableSpeedLimit)
                {
                    maxBytesPerSecond = (long)((global::MW3Download.Properties.Settings.Default.SpeedLimit * 1024) / DownloadManager.Instance.ActiveDownloads);
                }
                else
                {
